# PM103 Power Meter: Scope and Burst Mode SCPI Example
This example shows how to connect to the PM103 power meter and measure the power in software-triggered scope mode and external-triggered burst mode in SCPI commands. The basic CW mode example is also included. 
...
* Trigger Configuration: The example sets DIO1 (Pin2 of the PM103 DA-15 Connector) as the external trigger input port.
