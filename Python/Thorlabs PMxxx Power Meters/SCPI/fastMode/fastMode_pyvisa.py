...
to recent 10 ms of samples. The example works only for USB connection.
"""
...
def main():
    ...
    pm= rm.open_resource('USB0::0x1313::0x807A::M00795470::INSTR')
    pm.timeout=50000
    ...
    print("PM: ", pm.query('*IDN?').strip())
    print("Sensor: ",pm.query('SYST:SENS:IDN?').strip())
