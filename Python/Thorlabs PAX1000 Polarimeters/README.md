...
This sample code shows how to read measurement values in binary format, using Pyvisa and SCPI commands. This is useful for fast aquisition. The firmware version should be V1.2.1 or higher to run the example. This was also tested on Linux Mint 22.2, using pyvisa-py.
